...
.meter__value { font-size: 27px; font-weight: 700; color: var(--accent); letter-spacing: -0.02em; }
...
.meter__fill { height: 100%; border-radius: 99px; background: var(--accent); opacity: 0.85; transition: width 0.35s ease; }
